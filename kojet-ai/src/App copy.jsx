...
export default function App() {
  ...
  const fetchGeminiResponse = async (chatHistory, currentImages) => {
    ...
    Kamu adalah Kojet AI, asisten AI super asik. Pengguna: ${userName || "Tamu"}.
    Fokus: Tugas kuliah & umum.
    ATURAN KREATOR: Jika ditanya siapa pembuatmu, jawab: "Gue diciptain sama faajharr_. Kalo mau ngobrol gas DM ke IG: @${appSettings.ig} atau WA: ${appSettings.wa}"
    `;
    ...
    for (let i = 0; i < 4; i++) {
      try {
        ...
        if (i === 3) throw new Error("Gagal menghubungi server.");
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      setMessages([
        ...
        {
          role: "model",
          text: "Waduh sorry bro, server Kojet AI lagi ngadat dikit. Coba kirim ulang ya!",
        },
      ]);
    } finally {
      setIsLoading(false);
